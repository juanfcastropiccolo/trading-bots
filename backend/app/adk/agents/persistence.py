...
# Shared state: persistence agent writes, loop reads
# Keyed by agent_id
_last_tick_state: dict[int, dict] = {}


def get_last_tick_state(agent_id: int) -> dict | None:
    return _last_tick_state.pop(agent_id, None)
