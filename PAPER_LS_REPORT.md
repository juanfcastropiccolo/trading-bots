...
_Fase 3 de PLAN_FUTUROS.md. Actualizado: 2026-09-15 (tick automático vía GitHub Actions). Pesos con signo (− = short), funding real, costos 0.05% por lado, palanca 1x._
...
- **Equity:** $88.13 (-11.87% desde los $100 iniciales)
- **Posiciones:** SOL +0.37, XRP +0.26
- **Días corriendo:** 61 (desde 2026-07-17)
...
- **Equity:** $82.68 (-17.32% desde los $100 iniciales)
