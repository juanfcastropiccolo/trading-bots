...
_Fase 3 de PLAN_FUTUROS.md. Actualizado: 2026-09-14 (tick automático vía GitHub Actions). Pesos con signo (− = short), funding real, costos 0.05% por lado, palanca 1x._
...
- **Equity:** $92.42 (-7.58% desde los $100 iniciales)
- **Posiciones:** SOL +0.37, XRP +0.26
- **Días corriendo:** 60 (desde 2026-07-17)
...
- **Equity:** $87.13 (-12.87% desde los $100 iniciales)
