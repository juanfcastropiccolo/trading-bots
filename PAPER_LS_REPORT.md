...
_Fase 3 de PLAN_FUTUROS.md. Actualizado: 2026-09-07 (tick automático vía GitHub Actions). Pesos con signo (− = short), funding real, costos 0.05% por lado, palanca 1x._
...
- **Equity:** $95.83 (-4.17% desde los $100 iniciales)
- **Posiciones:** LINK +0.31, SOL +0.39
- **Días corriendo:** 53 (desde 2026-07-17)
...
- **Equity:** $92.25 (-7.75% desde los $100 iniciales)
